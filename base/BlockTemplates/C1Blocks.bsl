...
// Функция simple_block_execute_с1
//
// Параметры:
...
Функция simple_block_execute_с1(block_type, node, path, context, block_context, БлокВыполнен) 
	...
	ИначеЕсли block_type = "c1_predefine_value" Тогда
		simple_block_before_execute(node, path, context, block_context);
		result = block_c1_predefine_value_calc_value(block_type, node, path, context, block_context);
	...
	ИначеЕсли block_type = "c1_execute3" Тогда
		simple_block_before_execute(node, path, context, block_context);
		result = block_c1_execute3_calc_value(block_type, node, path, context, block_context);
	ИначеЕсли block_type = "c1_tab_doc_to_pdf" Тогда
		simple_block_before_execute(node, path, context, block_context);
		result = block_c1_tab_doc_to_pdf_calc_value(block_type, node, path, context, block_context);
	Иначе
		БлокВыполнен = Ложь;
	КонецЕсли;
	Возврат result;
...
Функция block_execute_core_с1(block_type, node, path, context, block_context, БлокВыполнен)
	...
	ИначеЕсли block_type = "c1_call_select2" Тогда
		result = block_c1_call_select2_execute(block_type, node, path, context, block_context);
