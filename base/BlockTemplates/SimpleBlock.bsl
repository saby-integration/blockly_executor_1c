...
// Процедура simple_block_before_execute
//
// Параметры:
...
#Область include_BlocklyExecutor_base_BlockTemplates_EsdBlocks
#КонецОбласти // include_BlocklyExecutor_base_BlockTemplates_EsdBlocks

#Область include_BlocklyExecutor_base_BlockTemplates_DatetimeBlocks
#КонецОбласти

// Функция block_check_required_param_in_block_context
//
// Параметры:
// required_param - Соответствие - Параметры
// block_context - Соответствие - Контекст текущего выполняемого блока
//
