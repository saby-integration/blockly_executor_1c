...
Процедура ВыполнитьКоманду(Идентификатор, ПараметрыВыполненияКоманды = Неопределено) Экспорт
	ЗаписьЖурналаРегистрацииНаСервере("Это "+ЛокализацияНазваниеПродукта()+" Событие",ЛокализацияНазваниеПродукта()+" Данные",ЛокализацияНазваниеПродукта()+" ФЗ начало");
	Попытка	
		...
		Если get_prop(ОбщиеПараметры, "refresh_statuses") = Истина Тогда 
			ЗаписьЖурналаРегистрацииНаСервере("Это "+ЛокализацияНазваниеПродукта()+" Событие",ЛокализацияНазваниеПродукта()+" Данные",ЛокализацияНазваниеПродукта()+" ФЗ Обновление статусов началось");
			...
			Если Результат["status"] = "complete" Тогда
						ЗаписьЖурналаРегистрацииНаСервере("Это "+ЛокализацияНазваниеПродукта()+" Событие",ЛокализацияНазваниеПродукта()+" Данные",ЛокализацияНазваниеПродукта()+" ФЗ Обновление статусов выполнено успешно");
			Иначе
				ЗаписьЖурналаРегистрацииНаСервере("Это "+ЛокализацияНазваниеПродукта()+" Событие",ЛокализацияНазваниеПродукта()+" Данные",ЛокализацияНазваниеПродукта()+" ФЗ Обновление статусов завершено с ошибкой");		
			КонецЕсли	
		КонецЕсли;	
		//Обновление статусов
		
		ЗаписьЖурналаРегистрацииНаСервере("Это "+ЛокализацияНазваниеПродукта()+" Событие",ЛокализацияНазваниеПродукта()+" Данные",ЛокализацияНазваниеПродукта()+" ФЗ выполнено");	
	Исключение
		//ИнфОбОшибке = ИнформацияОбОшибке();
		//ОшибкаСтруктура = NewExtExceptionСтруктура(ИнфОбОшибке);
		ЗаписьЖурналаРегистрацииНаСервере("Это "+ЛокализацияНазваниеПродукта()+" Событие",ЛокализацияНазваниеПродукта()+" Данные",ЛокализацияНазваниеПродукта()+" ФЗ ошибка");
	КонецПопытки	
КонецПроцедуры
